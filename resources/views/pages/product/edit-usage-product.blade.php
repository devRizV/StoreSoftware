              ...
              <form id="quickForm" action="{{route('update-usage-product', $product->pk_no)}}" method="get">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                        <label for="brand">Sold to <span style="color:red;">*</span></label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                       <div class="form-group">
                        <label for="name">Sold Date <span style="color:red;">*</span></label> <br>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                          ...
                          <div class="col-6">
                            <div class="form-group">
                              <label for="brand">Product Unit <span style="color:red;">*</span></label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                       <div class="form-group">
                        <label for="brand">Sold Price <span style="color:red;">*</span></label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                       <div class="form-group">
                          <label for="brand">Purchase Total <span style="color:red;">*</span></label>
                        <input type="text" name="grandtotal" value="{{$product->prd_grand_price}}" class="form-control" id="grandtotal" placeholder="Purchase total">
                          <input type="hidden" id="reqdept" name="reqdept" value="sold">
                       </div>
                     </div>
                   </div>
                        <!-- 
