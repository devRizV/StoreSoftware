...
class ProductController extends Controller
{
    ...
    /** 
    *   Go to multiple products entry form
    * 
    */
    ...
    public function getProductUnit(Request $request){
        ...
        return response()->json([$productUnit->prd_unit]);
    }
    ...
    /** 
    * For storing multiple products at once!!
    * Added (09/05/2024)
    */
    // Store multiple
    //store product
