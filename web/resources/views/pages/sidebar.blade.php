        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" >
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('multi-product-store')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Multiple Products</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('multi-usage-product')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Usage Multiple Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('all-usage-product')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Usage Product List</p>
                </a>
              </li>
            </ul>
          </li>
